# -*- coding: utf-8 -*-
"""
Created on Fri May 22 17:15:31 2020

@author: Mues
Die Klasse repräsentiert die Plotly-Version der Webseite der Küche
"""
...
class Kueche:
    ...
    def kueche_seite(self, uhrzeiten, dashboard_datum_liste, dashboard_uhrzeit):
                                                                        ...
                                                                        html.Div(className='col-lg-7 left',
                                                                                 children=[
                                                                                             ...
                                                                                             html.Div(className='container-fluid data-container',
                                                                                                      id='Durchschnitt_Temp_Luftfeuchte_Kueche',
                                                                                                      children=
                                                                                                                  html.Div(className='row',
                                                                                                                           children=[
                                                                                             ...
                                                                                             html.Div(children=dcc.Graph(
                                                                                                                             id='Graph_Temperatur_Kueche',
                                                                                                                             figure = {
                                                                                                                                 'data': [
                                                                                                                                             {'x': result['datum'], 'y': result['t1'], 'type': 'scatter', 'name': 'Temperatur [°C]', 'textposition' : 'bottom center' ,'marker' : { 'color' : '#33C1B1'}},
                                                                                                                                         ],
                                                                                                                                  'layout': {
                                                                                                                                              'title': 'Temperatur',
																	      'yaxis' : { 'title' : 'Temperatur [°C]' }
                                                                                               ...
                                                                                               html.Div(style={'margin-top': '50px'},
                                                                                                        children=dcc.Graph(
                                                                                                                              id='Graph_Luftfeucht_Kueche',
                                                                                                                              figure = {
                                                                                                                                  'data': [
                                                                                                                                              {'x': result['datum'], 'y': result['rh_1'], 'type': 'scatter', 'name': 'Luftfeuchte [%]', 'textposition' : 'bottom center' ,'marker' : { 'color' : '#33C1B1'}},
                                                                                                                                          ],
                                                                                                                                   'layout': {
