# -*- coding: utf-8 -*-
"""
Created on Fri May 22 17:14:38 2020

@author: Mues
Die Klasse repräsentiert die Plotly-Version der Webseite des Kinderzimmers
"""
...
class Kinder:
    ...
    def kinder_seite(self, uhrzeiten, dashboard_datum_liste, dashboard_uhrzeit):
            ...
            if(dashboard_datum_liste != None and dashboard_uhrzeit != None):                               
                ...
                result = DB_connector.get_data(day1, day2, 'a', ['t8', 'rh_8'])                    
                initial_datum = dt(int(dashboard_datum_liste[0]), int(dashboard_datum_liste[1]), int(dashboard_datum_liste[2]))              
                result_durchschnitt = DB_connector.get_data(day1, day2, 'a', ['t8', 'rh_8'])
                
                durchschnitt_temp = np.array(result_durchschnitt['t8']).mean().round(2)
                durchschnitt_luftfeucht = np.array(result_durchschnitt['rh_8']).mean().round(2)
                                                                        ...
                                                                        html.Div(className='col-lg-7 left',
                                                                                 children=[
                                                                                             ...
                                                                                             html.Div(className='container-fluid data-container',
                                                                                                      id='Durchschnitt_Temp_Luftfeuchte_Kinder',
                                                                                                      children=
                                                                                                                  html.Div(className='row',
                                                                                                                           children=[
