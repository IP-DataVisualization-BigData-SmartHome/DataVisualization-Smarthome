                                                          ...
                                                          children= [
                                                                                                                 ...
                                                                                                                 html.Div(className='col-3',
                                                                                                                          children= [
                                                                                                                                      html.Div(className='frame', 
                                                                                                                                               children= [
                                                                                                                                                           dcc.Input(className='checkbox', name='room', type='checkbox', value='1', id = 'Alle'),
                                                                                                                                                           html.Label(className='room-selection', htmlFor = 'Alle', children='Alle')
                                                                                                                                                         ]
                                                                                                                                               ),
                                                                                                                                      html.Div(className='frame', 
                                                                                                                                               children= [
                                                                                                                                                           dcc.Input(className='checkbox', name='room', type='checkbox', value='2', id = 'Arbeitszimmer'),
                                                                                                                                                           html.Label(className='room-selection', htmlFor = 'Arbeitszimmer', children='Arbeitszimmer')
                                                                                                                                                         ]
                                                                                                                                               ),
                                                                                                                                      html.Div(className='frame', 
                                                                                                                                               children= [
                                                                                                                                                           dcc.Input(className='checkbox', name='room', type='checkbox', value='3', id = 'Badezimmer'),
                                                                                                                                                           html.Label(className='room-selection', htmlFor = 'Badezimmer', children='Badezimmer')
                                                                                                                                                         ]
                                                                                                                                               ),
                                                                                                                                      html.Div(className='frame', 
                                                                                                                                               children= [
                                                                                                                                                           dcc.Input(className='checkbox', name='room', type='checkbox', value='4', id = 'Bügelzimmer'),
                                                                                                                                                           html.Label(className='room-selection', htmlFor = 'Bügelzimmer', children='Bügelzimmer')
                                                                                                                                                         ]
                                                                                                                                               ),
                                                                                                                                      html.Div(className='frame', 
                                                                                                                                               children= [
                                                                                                                                                           dcc.Input(className='checkbox', name='room', type='checkbox', value='5', id = 'Kinderzimmer'),
                                                                                                                                                           html.Label(className='room-selection', htmlFor = 'Kinderzimmer', children='Kinderzimmer')
                                                                                                                                                         ]
                                                                                                                                               ),                                                                   
                                                                                                                                      html.Div(className='frame', 
                                                                                                                                               children= [
                                                                                                                                                           dcc.Input(className='checkbox', name='room', type='checkbox', value='6', id = 'Küche'),
                                                                                                                                                           html.Label(className='room-selection', htmlFor = 'Küche', children='Küche')
                                                                                                                                                         ]
                                                                                                                                               ),                  
                                                                                                                                      html.Div(className='frame', 
                                                                                                                                               children= [
                                                                                                                                                           dcc.Input(className='checkbox', name='room', type='checkbox', value='7', id = 'Schlafzimmer'),
                                                                                                                                                           html.Label(className='room-selection', htmlFor = 'Schlafzimmer', children='Schlafzimmer')
                                                                                                                                                         ]
                                                                                                                                               ),
                                                                                                                                      html.Div(className='frame', 
                                                                                                                                               children= [
                                                                                                                                                           dcc.Input(className='checkbox', name='room', type='checkbox', value='8', id = 'Waschküche'),
                                                                                                                                                           html.Label(className='room-selection', htmlFor = 'Waschküche', children='Waschküche')
                                                                                                                                                         ]
                                                                                                                                               ),         
                                                                                                                                      html.Div(className='frame', 
                                                                                                                                               children= [
                                                                                                                                                           dcc.Input(className='checkbox', name='room', type='checkbox', value='9', id = 'Wohnzimmer'),
                                                                                            ...
                                                                                            html.Div(className='row',
                                                                                                     children= [
                                                                                                               html.Div(className='col-3',
                                                                                                                        children=
                                                                                                                                    html.Button(type='submit', value='Absenden')
                                                                                                                        ),
                                                                                                               html.Div(className='col-9',
                                                                                                                        children = [
